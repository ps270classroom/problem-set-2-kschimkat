...
There are 7,014 total candidates in the data set. 
...
knitr::kable(party_incumbent_promote, digits = 3, col.names = c("Party", "Incumbency", "Average Candidate Promotion"))
```

Democrat incumbents in the US House and US Senate sponsored the most promoting ads on average.
...
The shape of the histogram is skewed to the right, meaning most of the facebook ad impressions are on the far left side of the graph towards 0. Most of the US House candidates did not have more than 10 million ad impressions on facebook. 
